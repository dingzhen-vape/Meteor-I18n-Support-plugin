...
public class AboutThisPlugin extends Module {
    ...
    public void onActivate() {
        //1.20.5
        if (TranslateAddon.MC.player != null) {
            TranslateAddon.MC.player.sendMessage(Text.literal("插件作者|译者：食我压路" +
            ...
            TranslateAddon.MC.player.sendMessage(Text.literal("点我跳转译者B站主页").styled(s -> s.withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL,("https://space.bilibili.com/432060575?spm_id_from=333.1007.0.0")))));
            TranslateAddon.MC.player.sendMessage(Text.literal("点我跳转插件仓库").styled(s -> s.withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL,("https://github.com/dingzhen-vape/Meteor-Translate-plugin")))));
...
//        ChatUtils.sendMsg(Text.literal("点我跳转插件仓库").styled(s -> s.withClickEvent(new ClickEvent.OpenUrl(URI.create("https://github.com/dingzhen-vape/Meteor-Translate-plugin")))));
