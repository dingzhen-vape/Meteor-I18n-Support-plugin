...
public class ModuleExample extends Module {
    ...
    public ModuleExample() {
        super(TranslateAddon.CATEGORY, "world-origin", "An example module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link TranslateAddon#getPackage()} to be setup correctly, otherwise the game will crash whenever the module is enabled.
     */
    @EventHandler
